...
<table width="100%"><tbody><tr><td width="7%"><td align=center>
	...
	<script language="JavaScript">
		...
		function al() {
		alert("Cảm ơn kênhit.vn nhiều lém!!");
		alert("Đã làm cho trái tim tớ hết đơn coi và lạnh giá");
		alert("Nắm tay tớ nha, mãi mãi của nhau hoy vì tớ iu cậu nhìu lém. Chỉ qua mạng hoy nhưng ty đến là thật");
		alert("Đi nào....  !!!!");
		}
	</script>
<ul id="scroll">
...
<p id="copy" onClick="window.open('http://kênhit.vn','')">© 2017 By KênhIT.VN
</p>
<script>
